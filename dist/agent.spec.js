...
describe("failed transaction agent", function () {
    var handleTransaction;
    var createFailedTxEvent = function () { return (0, forta_agent_1.createTransactionEvent)({
        transaction: {
    ...
    describe("failed transaction", function () {
        it("is failed", function () { return __awaiter(void 0, void 0, void 0, function () {
            var txEvent, findings;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        txEvent = createFailedTxEvent();
